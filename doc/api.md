...
Microcluster offers a default REST API for managing the cluster called the Core API.

The Core API is offered both over the local unix socket, as well as over the cluster address of initialized clusters.
